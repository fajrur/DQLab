...
# "Variable" (https://academy.dqlab.id/main/livecode/1/3/10?pr=0)
budi_berat_kg <- 68
santi_berat_kg <- 54.5
budi_berat_kg
santi_berat_kg
...
# "Vector" (https://academy.dqlab.id/main/livecode/1/4/14?pr=0)
...
# "Named Vector" (https://academy.dqlab.id/main/livecode/1/4/16?pr=0)
...
# uat vector baru sebagai representasi akreditasi
...
# "Membaca File Excel" (https://academy.dqlab.id/main/livecode/1/5/24?pr=0)
# Menggunakan package ggplot2
library(ggplot2)
